...
export default function Video() {
    ...
    const [collections, setCollections] = useState([{ address: '0x05be551CCC7441523Ec3a88216f8f69587c14573', network: 'Theta Testnet' }]);
    ...
    if(apiKeys.secret == '' || apiKeys.key == '') {
        ...
        {
            setApiKeys({key: process.env.API_KEY as string, secret: process.env.API_SECRET as string})
        }
    }
